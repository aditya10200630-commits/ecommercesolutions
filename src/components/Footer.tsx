          ...
          <div>
            <a href="#" onClick={(e) => { e.preventDefault(); scrollToTop(); }} className="flex items-center gap-2.5 mb-4">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-lg font-extrabold text-white tracking-tight">eComSolution</span>
                <span className="text-[9px] font-semibold tracking-[0.2em] uppercase text-brand-400">.co.in</span>
              </div>
            </a>
